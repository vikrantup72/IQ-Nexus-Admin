...
const UpdateAdvanceList = () => {
    ...
    const handleDrop = (e) => {
        ...
        if (e.dataTransfer.files && e.dataTransfer.files[0]) {
            ...
            if (droppedFile.type === "application/vnd.ms-excel" || droppedFile.type === "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet") {
                setFile(droppedFile);
                setUploadStatus("");
            } else {
    ...
    const getStatusColor = () => {
        ...
        if (uploadStatus.includes("Failed") || uploadStatus.includes("Please select")) return "text-red-600";
    ...
    const getStatusIcon = () => {
        ...
        if (uploadStatus.includes("Failed") || uploadStatus.includes("Please select")) {
            return (
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div className="bg-gray-50 px-6 md:px-8 py-6 border-t border-gray-100">
                        <div className="flex items-start space-x-3">
                            ...
                            <div>
                                <h3 className="text-sm font-semibold text-gray-800 mb-1">File Requirements</h3>
